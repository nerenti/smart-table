...
pages.firstElementChild.remove();// @todo: #2.3 — подготовить шаблон кнопки для страницы и очистить контейнер
...
let page = state.page;  // @todo: #2.1 — посчитать количество страниц, объявить переменные и константы
...
totalRows.textContent = data.length;// @todo: #2.5 — обновить статус пагинации
